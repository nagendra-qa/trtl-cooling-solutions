  ...
  return (
    <div style={{ paddingTop: '20px' }}>
      <div className="container">
        ...
        {/* Business Hours */}
        <div className="card" style={{ textAlign: 'center', marginBottom: '60px' }}>
          <h2 style={{ color: 'var(--dark-blue)', marginBottom: '20px' }}>Business Hours</h2>
          <div style={{
            display: 'grid',
            ...
            <div>
              <h4 style={{ color: 'var(--dark-blue)', marginBottom: '8px' }}>Monday - Saturday</h4>
              <p style={{ color: '#666', fontSize: '16px' }}>9:00 AM - 7:00 PM</p>
            </div>
            <div>
              <h4 style={{ color: 'var(--dark-blue)', marginBottom: '8px' }}>Sunday</h4>
              <p style={{ color: '#666', fontSize: '16px' }}>10:00 AM - 5:00 PM</p>
            </div>
            <div>
              <h4 style={{ color: 'var(--dark-blue)', marginBottom: '8px' }}>Emergency</h4>
              <p style={{ color: '#666', fontSize: '16px' }}>24/7 Available</p>
            </div>
          </div>
        </div>
      </div>
